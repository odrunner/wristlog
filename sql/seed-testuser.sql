-- ══════════════════════════════════════════════════════════════════════════════
--  WRISTLOG — TEST ACCOUNT SEED SCRIPT
-- ══════════════════════════════════════════════════════════════════════════════
--  For test@wrotate.com (UUID: e0af1615-b151-4260-b6bd-c23e497efa6d)
--  Run this in Supabase SQL Editor to populate the test account with data.
-- ══════════════════════════════════════════════════════════════════════════════

BEGIN;

-- ─── Clean slate ─────────────────────────────────────────────────────────────
DELETE FROM logs     WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d';
DELETE FROM wishlist WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d';
DELETE FROM watches  WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d';
...
(gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d',
...
BEGIN
  ...
  SELECT id INTO v_sub_id     FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = '126610LN';
  SELECT id INTO v_speedy_id  FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = '310.30.42.50.01.002';
  SELECT id INTO v_bb58_id    FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'M79030N';
  SELECT id INTO v_gs_id      FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'SBGA211';
  SELECT id INTO v_iwc_id     FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'IW371605';
  SELECT id INTO v_santos_id  FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'WSSA0029';
  SELECT id INTO v_gmt_id     FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = '126710BLNR';
  SELECT id INTO v_jlc_id     FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'Q3858520';
  SELECT id INTO v_seiko_id   FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'SRPB43';
  SELECT id INTO v_gshock_id  FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'GA-2100-1A1';
  SELECT id INTO v_zenith_id  FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = '03.3100.3600';
  SELECT id INTO v_panerai_id FROM watches WHERE user_id = 'e0af1615-b151-4260-b6bd-c23e497efa6d' AND ref = 'PAM01312';
  ...
  INSERT INTO logs (id, user_id, watch_id, date, use_case, notes, photo_url, visibility, club_id)
  VALUES
    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-03-20', 'unspecified',
     'Just reorganized my watch box. The collection is really coming together.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-04-15', 'unspecified',
     'Visited the Omega boutique today. The new Moonshine Gold Speedmaster in person is something else.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-05-28', 'unspecified',
     'Hot take: the best watch in any collection is the one you actually wear.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-07-04', 'unspecified',
     'Happy Fourth! Rocking the red, white and blue — Pepsi GMT would have been perfect but Batman will do.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-08-12', 'unspecified',
     'Thinking about adding a proper field watch to the rotation. Maybe a Hamilton Khaki?',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-09-30', 'unspecified',
     'Three months of tracking wear data and the Submariner is the clear daily champion. No surprise there.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-11-15', 'unspecified',
     'The Snowflake dial in autumn light is unreal. Spring Drive sweep never gets old.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2025-12-25', 'unspecified',
     'Christmas gift to myself: a custom leather strap for the Reverso. Burgundy alligator.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2026-01-10', 'unspecified',
     'New year resolution: wear the JLC and Seiko more. They deserve more wrist time.',
     NULL, 'public', NULL),

    (gen_random_uuid()::text, 'e0af1615-b151-4260-b6bd-c23e497efa6d', NULL, '2026-02-14', 'unspecified',
...
-- ══════════════════════════════════════════════════════════════════════════════
--  Done! Test account now has:
--   • 1 profile (Test User / @testuser)
