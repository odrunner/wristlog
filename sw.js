...
const PRECACHE = ['/', '/design-system.css?v=7ca33db3', '/model-page.js?v=688e00ab', '/manifest.json', '/icon.svg', '/profile/', '/p/'];
  ...
  e.waitUntil(
    caches.open(CACHE)
      .then(c => c.addAll(PRECACHE)
        .then(() => c.match('/'))
        .then(res => res ? c.put('/index.html', res.clone()) : undefined))
