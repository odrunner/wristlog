...
export const SHARED_LIGHT = {
  ...
  '--glow-success': '0 0 6px var(--success)',
  '--shadow-ring-tag': '0 0 0 3px color-mix(in srgb, var(--tag-type) 20%, transparent)',
  '--shadow-ring-win': '0 0 0 3px color-mix(in srgb, var(--tg-ink) 25%, transparent)',
  '--shadow-drag': '0 8px 32px var(--scrim)',
  '--shadow-lift': '0 4px 16px color-mix(in srgb, var(--black) 10%, transparent)',
  '--shadow-btn-hover': '0 1px 6px color-mix(in srgb, var(--black) 20%, transparent)',
  '--shadow-toast': '0 8px 32px color-mix(in srgb, var(--black) 15%, transparent), 0 0 12px color-mix(in srgb, var(--badge-tier) 6%, transparent)',
  '--scrim': 'rgba(0,0,0,.55)',
  '--z-fab': '90',
  '--z-raised': '1', '--z-raised-2': '2', '--z-raised-3': '3', '--z-dropdown': '10', '--z-card-menu': '20',
  '--z-header': '100',
  '--z-modal': '200',
  '--z-modal-top': '210',
  '--z-nav': '300',
  ...
  '--paper': '#f5f5f8', '--cream': '#FEFCF6', '--sand': '#F0E2B4',
  ...
  '--danger-fill': '#b91c1c',
  '--streak-frozen-bg': '#cfe8f5', '--streak-frozen-ink': '#0c4a6e', '--chip-warn-bg': '#fde68a', '--chip-warn-ink': '#7c2d12',
  '--tg-ink': '#4ade80',
  '--tg-bg': '#0a1a12',
  '--tg-card-ink': '#e8efd9',
  '--tg-error-bg': 'rgba(127,29,29,.3)',
  ...
  '--badge-deep': '#633806',
  '--badge-ink': '#3D2A14',
  '--badge-onboarding': '#7A8B5C',
  '--badge-onboarding-ink': 'color-mix(in srgb, var(--badge-onboarding) 58%, black)',
  '--badge-onboarding-bg': 'color-mix(in srgb, var(--badge-onboarding) 20%, white)',
  '--badge-connoisseur': '#6B3D52',
  '--badge-connoisseur-ink': 'color-mix(in srgb, var(--badge-connoisseur) 58%, black)',
  '--badge-connoisseur-bg': 'color-mix(in srgb, var(--badge-connoisseur) 20%, white)',
  '--badge-timegrapher': '#4A6B7D',
  '--badge-timegrapher-ink': 'color-mix(in srgb, var(--badge-timegrapher) 58%, black)',
  '--badge-timegrapher-bg': 'color-mix(in srgb, var(--badge-timegrapher) 20%, white)',
  '--badge-habit': '#B5663F',
  '--badge-habit-ink': 'color-mix(in srgb, var(--badge-habit) 58%, black)',
  '--badge-habit-bg': 'color-mix(in srgb, var(--badge-habit) 20%, white)',
  '--badge-hidden': '#7A7A6A',
  '--badge-hidden-ink': 'color-mix(in srgb, var(--badge-hidden) 58%, black)',
  '--badge-hidden-bg': 'color-mix(in srgb, var(--badge-hidden) 20%, white)',
  '--badge-locked': '#C9C2A8', '--badge-locked-ink': '#A8A28C',
  '--watch-gold': '#c9a84c',
  '--watch-green': 'var(--success)',
  '--watch-indigo': '#818cf8',
  '--watch-orange': 'var(--status-expiring)',
  '--watch-sky': '#38bdf8',
...
export const SHARED_OTHER = [
  ...
  '--nav-h',
  '--promo-gold-deep',
  '--promo-parchment', '--promo-line', '--promo-band-body',
  '--promo-cta-fg',
  '--promo-radius', '--promo-radius-shot', '--promo-fs-heading', '--promo-fs-hero', '--promo-fs-prompt', '--promo-fs-flat', '--promo-fs-delta', '--promo-fs-fallback', '--promo-fs-streak', '--promo-fs-mark', '--promo-ls-label', '--promo-ls-year', '--promo-ls-tight', '--promo-ls-tight-2', '--promo-ls-tight-4', '--promo-ls-mark', '--promo-lh-eyebrow', '--promo-lh-eyebrow-sm', '--promo-edge',
];
