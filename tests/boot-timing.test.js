...
describe('bootTimingPayload', () => {
  ...
  it('rounds every mark to whole milliseconds', () => {
    ...
    expect(p).toMatchObject({
      ...
      sw_controlled: true, cached_feed: true, feed_error: false, optimistic_boot: false, early_feed: false, social_cache: false,
    });
  });
  ...
  it('survives a missing navigation entry and missing marks', () => {
    ...
    expect(p).toEqual({
      ...
      sw_controlled: false, cached_feed: false, feed_error: false, optimistic_boot: false, early_feed: false, social_cache: false,
    });
  });
