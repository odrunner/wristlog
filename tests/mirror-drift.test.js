...
const VERBATIM = [
  ...
  'msrCardHasEnoughData', 'unsavedReadingLabel', 'msrCardResultText', 'msrCardShowScope', 'msrCardAmpText', 'normalizeLocation', 'onboardingChecklistState', 'parsePhotoUrl', '_q2Ls',
