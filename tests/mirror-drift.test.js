...
const VERBATIM = [
  ...
  'canDeleteComment', 'classifyDevice', 'computeMedianRate', 'sessionSettleAction', 'decodeAuthUser', 'decodeAuthUserId', 'eloExpected', 'followNeedsRequest',
  ...
  'socialCacheKey', 'serializeSocialCache', 'parseSocialCache', 'socialSignature', 'shouldRefreshOnBackground', 'feedPageToState', 'feedRpcHintKey', 'experimentSpeedHtml', 'knobTrialProgressHtml',
...
const ADAPTED = [
  ...
  'SPEED_EXPERIMENTS', 'KNOB_TRIAL_MIN',
